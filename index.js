...
const ScrollableTabView = createReactClass({
    ...
    componentWillUnmount() {
        this.state.scrollXIOS && this.state.scrollXIOS.removeAllListeners();
    },
    ...
    render() {
        ...
        //     tabBarProps.bottomPadding = this.props.bottomPadding;
        // }

        // if (this.props.topPadding) {
        //     tabBarProps.topPadding  = this.props.topPadding;
        // }

        if (this.props.underlineWidth) {
            tabBarProps.underlineWidth = this.props.underlineWidth;
        }

        if (this.props.underlineColor) {
            tabBarProps.underlineColor = this.props.underlineColor;
        }

        if (overlayTabs) {

            let top_bottom_gap = 0;
            if (this.props.tabBarPosition === 'overlayTop') {
                top_bottom_gap = this.props.topPadding || 0;
            } else {
                top_bottom_gap = this.props.bottomPadding || 0;
            }
            ...
            tabBarProps.style = {
                ...
                left: 0,
                right: 0,
                [this.props.tabBarPosition === 'overlayTop' ? 'top' : 'bottom']: top_bottom_gap,
            };
        }
